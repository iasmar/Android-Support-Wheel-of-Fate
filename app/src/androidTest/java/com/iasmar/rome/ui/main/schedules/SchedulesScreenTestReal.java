...
/**
 * Tests for the Schedules screen, the main screen which contains a list of all Schedules.
 */
...
@LargeTest
public class SchedulesScreenTestReal {
    /**
    ...
    public ActivityTestRule<MainActivity> mMainActivityTestRule =
            new ActivityTestRule<MainActivity>(MainActivity.class) {
                ...
                /**
                 * To avoid a long list of Schedules and the need to scroll through the list to find a
                 * schedule, we call {@link EngineersDataSource ()} before each test.
                 */
                @Override
...
//// TODO fix test AmbiguousViewMatcherException (the schedule has the same name twice)
...
// TODO use the data in the mock to avoid failing the test when data is changed
        ...
        //Verify that all our Schedules are shown
